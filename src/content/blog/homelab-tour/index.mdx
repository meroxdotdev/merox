---
title: "Complete Homelab Tour 2026"
...
date: 2025-07-02
tags: ["infrastructure", "homelab", "kubernetes",  "flux", "proxmox"]
image: './homelab.svg'
---
...
![Homelab 2026](assets/homelab-tour/homelab-modified.webp)
...
![Homelab Network Topology Diagram showing Tailscale mesh connections](assets/homelab-tour/network.png)
...
![pfSense services dashboard showing active services](assets/homelab-tour/pfsense-services.webp)
...
![UPS monitoring dashboard showing power statistics](assets/homelab-tour/ups.webp)
...
![Telegram UPS notification showing power alert](assets/homelab-tour/telegram-notif1.webp)
...
![Synology services overview dashboard](assets/homelab-tour/synology.webp)
...
![iDRAC management interface for Dell R720](assets/homelab-tour/idrac-dellr720.webp)
...
![Proxmox cluster overview showing all nodes](assets/homelab-tour/proxmox.webp)
...
![Hetzner cloud dashboard showing VPS instances](assets/homelab-tour/hetzner.webp)

**Infrastructure Overview**

All managed through a single Portainer instance at `cloud.merox.dev`:

![Portainer multi-cluster view showing all environments](assets/homelab-tour/clusters.webp)
...
![Monitoring with Grafana and Loki](assets/homelab-tour/grafana-loki.webp)
...
![Lens Kubernetes IDE showing cluster overview with nodes, pods, and resource utilization](assets/homelab-tour/lens-k8s-overview.webp)
...
![Homepage dashboard showing all services](assets/homelab-tour/dashboard.webp)
...
![Longhorn dashboard](assets/homelab-tour/longhorn.webp)

- **MinIO on R720** → Weekly sync to Hetzner Storagebox
- **Result**: Complete 3-2-1 backup strategy

![MinIO dashboard](assets/homelab-tour/minio.webp)

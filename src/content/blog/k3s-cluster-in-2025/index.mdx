...
- Configures **cloud-init ubuntu** settings for automated provisioning
- Converts it into a template for rapid VM deployment

**Option 2: Deploy VMs**  
- Clones the **Cloud-Init** template to create the desired number of VMs  
- Automatically configures **ubuntu cloud-init** settings including:

...
date: 2024-08-16
tags: ["infrastructure", "ai", "self-hosting", "server", "ollama", "stable-diffusion"]
image: './webui.svg'
---
...
![Stable Diffusion Web Interface](assets/stablediffusion.png)
...
![OpenWebUI Admin Settings](assets/openwebuiaset.png)
...
![Stable Diffusion Integration](assets/stablediffusionaset.png)

**Voilà!**

![OpenWebUI Interface](assets/meroxai.png)

...
date: 2025-04-07
tags: ["infrastructure", "wordpress", "hugo", "github-actions", "github-pages", "cloudflare", "static-site", "website-setup", "migration"]
image: './wphugo.svg'
---
...
![WordPress Vulnerabilities](assets/wpscan-vuln-statistics.png)
...
![Hugo Website](assets/hugo-website.png)
...
![GitHub Pages Setup](assets/github-pages.png)
...
![SEO Score Analysis 1](assets/seochecker.png)

From [https://freetools.seobility.net/](https://freetools.seobility.net/)

![SEO Score Analysis 2](assets/seocheckup.png)

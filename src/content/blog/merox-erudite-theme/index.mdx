...
![merox-erudite theme preview](./preview.png)
...
I wanted comments on my blog posts, so I integrated Giscus (GitHub Discussions) with:
...
<Callout variant="tip">
**Note:** Giscus is optional. If you don't configure it, the component simply won't render. You'll need a public GitHub repository with Discussions enabled.
</Callout>
...
```
PUBLIC_GISCUS_REPO=username/repo (can be Text)
PUBLIC_GISCUS_REPO_ID=your-repo-id (can be Text)
PUBLIC_GISCUS_CATEGORY=Blog Comments (can be Text)
PUBLIC_GISCUS_CATEGORY_ID=your-category-id (can be Text)
```

<Callout variant="tip">
Get your Giscus configuration values from [giscus.app](https://giscus.app) after enabling Discussions on your repository.
</Callout>

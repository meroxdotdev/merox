...
description: "After months of customizing astro-erudite for my blog, I decided to share my fork with the community. A batteries-included Astro theme with comments, analytics, and more."
date: 2025-12-05
...
6. **Optional features** - Set up comments or analytics if needed (see [Deployment](#deployment-on-cloudflare-pages) section for environment variables)
...
I recommend deploying merox-erudite on [Cloudflare Pages](https://pages.cloudflare.com/)—it's free, fast, and makes handling environment variables very straightforward.

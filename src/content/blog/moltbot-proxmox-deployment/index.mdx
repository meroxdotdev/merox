...
- **Node.js 22+** (the official installer uses npm and can install Node if missing)
...
The official OpenClaw installer uses **npm** and expects **Node.js 22+**:
...
<Callout variant="tip">
**Alternative Installation Methods**: OpenClaw also supports installation via Docker, Ansible, Nix, and cloud platforms (Railway, Render, Northflank). See the [official installation documentation](https://docs.openclaw.ai/install) for all available methods.
</Callout>
...
- [Node.js](https://nodejs.org/) - Runtime used by the official installer (npm)

...
date: 2025-04-14
tags: ["infrastructure", "dual-boot", "windows-11", "ubuntu-25-04", "linux", "ubuntu-installation", "partitioning", "grub", "dual-boot-tutorial", "uefi", "secure-boot"]
image: './dualboot.svg'
---

import Callout from '@/components/Callout.astro'

![Ubuntu 25 Installer](assets/ubuntu25install.webp)
...
![Windows Disk Management](assets/shrink-volume-to-partition-ssd-via-disk-management.webp)
...
![Windows Fast Startup](assets/fast-startup-w11.webp)
...
![Ubuntu Download Page](assets/ubuntu25.webp)
...
![Rufus USB Creator](assets/rufus.webp)
...
![Dual Boot Screen](assets/dual-boot-windows-11-and-ubuntu-create-ubuntu.webp)
